...
////// Lighting:
////// Emissive:
                float4 node_6657 = _Time + _TimeEditor;
                float3 node_1144 = floor(frac((_node_3855*lerp(_node_5602.rgb,_node_9075.rgb,((_timeScale*node_6657.r)+pow(distance(i.posWorld.rgb,_WorldSpaceCameraPos),_pow))))) * _node_4197) / (_node_4197 - 1);
